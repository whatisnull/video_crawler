...
class HTTPConnectionWithTimeout(httplib.HTTPConnection):
    ...
    def __init__(self, host, port=None, strict=None, timeout=None, proxy_info=None, source_ip=None):
    ...
    def connect(self):
        ...
        for res in socket.getaddrinfo(self.host, self.port, 0,
            ...
            try:
                ...
                if self.source_ip is not None:#bindip
...
class HTTPSConnectionWithTimeout(httplib.HTTPSConnection):
    ...
    def __init__(self, host, port=None, key_file=None, cert_file=None,
                 ...
                 ca_certs=None, disable_ssl_certificate_validation=False, source_ip=None):
                ...
                if redirections:
                    ...
                    if response.has_key('location'):
                        ...
                        if response.status in [302, 303]:
                            redirect_method = "GET"
                            if old_response.has_key('set-cookie'):
                                headers['Cookie'] = old_response['set-cookie']
                            body = None
...
# including all socket.* and httplib.* exceptions.
    ...
    def request(self, uri, method="GET", body=None, headers=None, redirections=DEFAULT_MAX_REDIRECTS, connection_type=None, source_ip=None, source_port=None, authority=None):
...
a string that contains the response entity body.
        ...
        try:
            ...
            if authority is None:
                ...
                (scheme, _, request_uri, defrag_uri) = urlnorm(uri)
                ...
                if issubclass(connection_type, HTTPSConnectionWithTimeout):
                    if certs:
                        conn = self.connections[conn_key] = connection_type(
                                ...
                                disable_ssl_certificate_validation=
                                        self.disable_ssl_certificate_validation, source_ip=source_ip, port=source_port)
                    else:
                        conn = self.connections[conn_key] = connection_type(
                    ...
                    conn = self.connections[conn_key] = connection_type(
                            authority, timeout=self.timeout,
                            proxy_info=proxy_info, source_ip=source_ip, port=source_port)
